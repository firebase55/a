...
public class fWeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_web);

        webView = findViewById(R.id.f_webview);
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public void onReceivedError(WebView webView, String errorCode, String description, String failingUrl){
                ...
                Toast.makeText(fWeb.this, description, Toast.LENGTH_SHORT).show();
            }
        });webView.loadUrl("https://quranicaudio.com/quran/14");
    }
}
