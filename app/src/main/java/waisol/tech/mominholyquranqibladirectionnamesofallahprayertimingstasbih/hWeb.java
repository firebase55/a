...
public class hWeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.h_webview);
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public void onReceivedError(WebView webView, String errorCode, String description, String failingUrl){
                ...
                Toast.makeText(hWeb.this, description, Toast.LENGTH_SHORT).show();
            }
        });webView.loadUrl("https://quranicaudio.com/quran/28");
    }
}
